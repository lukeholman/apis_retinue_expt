...
barplot_data %>% 
  select(study, mean, treatment) %>% 
  spread(study, mean) %>% 
  mutate(`Slessor et al. 1988` = as.numeric(scale(`Slessor et al. 1988`)),
         `Present study` = as.numeric(scale(`Present study`)),
         diff = `Slessor et al. 1988` - `Present study`)
